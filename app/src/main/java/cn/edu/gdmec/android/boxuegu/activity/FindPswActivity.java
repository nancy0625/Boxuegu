...
public class FindPswActivity extends AppCompatActivity implements View.OnClickListener{
    private EditText et_validate_name,et_user_name,et_newpsw;
    ...
    private boolean isExistUsername(String userName){
        boolean hasUserName = false; tv_reset_psw.setVisibility(View.VISIBLE);
        ...
        if ("security".equals(from)) {
            ...
            if (!validateName.equals(sp_security)) {
               ...
               // tv_reset_psw.setVisibility(View.VISIBLE);
                ...
                tv_reset_psw.setVisibility(View.VISIBLE);
                et_newpsw.setVisibility(View.VISIBLE);
                psw = et_newpsw.getText().toString().trim();
